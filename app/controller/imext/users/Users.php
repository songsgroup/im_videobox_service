    ...
    public function generate_code($mobile, $type, $type1, $bizparams = array())
    {
        ...
        if ($r0)
        {
            ...
            if ($type == 0)
            {
                ...
                $sql1 = "select SignName,TemplateCode from imext_message where store_id = '$store_id' and type = 0 and type1 = '$type1'";
                $r1 = Db::query($sql1);
                if ($r1)
                {
                ...
                else
                {
                    ...
                    $sql2 = "select SignName,TemplateCode from imext_message where store_id = '$store_id' and type = 0 and type1 = '1'";
                    $r2 = Db::query($sql2);
                    if ($r2)
                    {
